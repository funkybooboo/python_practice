...
def save_data(info, data, experiment):
    ...
    scoring["submission accuracy"] = blank_column(max_list_length)
    scoring["submission apply_feedback"] = blank_column(max_list_length)
    scoring["submission prop_errors"] = blank_column(max_list_length)
    scoring["submission prop_feedback"] = blank_column(max_list_length)
    scoring["submission add_incorrect"] = blank_column(max_list_length)
    scoring["submission feedback_incorrect"] = blank_column(max_list_length)
    scoring["submission disregard"] = blank_column(max_list_length)
    scoring["submission notes"] = blank_column(max_list_length)
    scoring[""] = blank_column(max_list_length)
    ...
    scoring["resubmission accuracy"] = blank_column(max_list_length)
    scoring["resubmission apply_feedback"] = blank_column(max_list_length)
    scoring["resubmission prop_errors"] = blank_column(max_list_length)
    scoring["resubmission prop_feedback"] = blank_column(max_list_length)
    scoring["resubmission add_incorrect"] = blank_column(max_list_length)
    scoring["resubmission feedback_incorrect"] = blank_column(max_list_length)
    scoring["resubmission disregard"] = blank_column(max_list_length)
    scoring["resubmission notes"] = blank_column(max_list_length)
